...
public enum IfwParameter {
    ...
    Osc1Waveform3("OSC 1 Waveform 3", Bool.Off),
    Osc2Waveform3("OSC 2 Waveform 3", Bool.Off),
    Osc3Waveform3("OSC 3 Waveform 3", Bool.Off),
    Osc4Waveform3("OSC 4 Waveform 3", Bool.Off),
    Lfo1Beat("LFO 1 Beat", LfoBeat.B1_4),
    Lfo2Beat("LFO 2 Beat", LfoBeat.B1_4),
    Dummy140("dummy 140", 0, 10, 0f),
    GateOpenSmoothTime("Gate Open Smooth Time", .1f, 1000, 2f), // ms
    GateCloseSmoothTime("Gate Close Smooth Time", .1f, 1000, 15f), // ms
    PitchBendSmoothTime("Pitch Bend Smooth Time", .1f, 1000, 5f), // ms
    BreathSmoothTime("Breath Smooth Time", .1f, 1000, 12f), // ms
    GlideSmoothTime("Glide Smooth Time", .1f, 1000, 5f), // ms
    ...
    Dummy150("dummy 150", 0, 10, 0f),
    Dummy151("dummy 151", 0, 10, 0f),
    Dummy152("dummy 152", 0, 10, 0f),
    Dummy153("dummy 153", 0, 10, 0f),
    Dummy154("dummy 154", 0, 10, 0f),
    Dummy155("dummy 155", 0, 10, 0f),
    Dummy156("dummy 156", 0, 10, 0f),
    Dummy157("dummy 157", 0, 10, 0f),
    Dummy158("dummy 158", 0, 10, 0f),
    Dummy159("dummy 159", 0, 10, 0f),
    Dummy160("dummy 160", 0, 10, 0f),
    Dummy161("dummy 161", 0, 10, 0f),
    Dummy162("dummy 162", 0, 10, 0f),
    Dummy163("dummy 163", 0, 10, 0f),
    Dummy164("dummy 164", 0, 10, 0f),
    Dummy165("dummy 165", 0, 10, 0f),
    Dummy166("dummy 166", 0, 10, 0f),
    Dummy167("dummy 167", 0, 10, 0f),
    Dummy168("dummy 168", 0, 10, 0f),
    Dummy169("dummy 169", 0, 10, 0f),
    Dummy170("dummy 170", 0, 10, 0f),
    Dummy171("dummy 171", 0, 10, 0f),
    Dummy172("dummy 172", 0, 10, 0f),
    Dummy173("dummy 173", 0, 10, 0f),
    Dummy174("dummy 174", 0, 10, 0f),
    Dummy175("dummy 175", 0, 10, 0f),
    Dummy176("dummy 176", 0, 10, 0f),
    Dummy177("dummy 177", 0, 10, 0f),
    Dummy178("dummy 178", 0, 10, 0f),
    Dummy179("dummy 179", 0, 10, 0f),
    Dummy180("dummy 180", 0, 10, 0f),
    Dummy181("dummy 181", 0, 10, 0f),
    Dummy182("dummy 182", 0, 10, 0f),
    Dummy183("dummy 183", 0, 10, 0f),
    Dummy184("dummy 184", 0, 10, 0f),
    Dummy185("dummy 185", 0, 10, 0f),
    Dummy186("dummy 186", 0, 10, 0f),
    Dummy187("dummy 187", 0, 10, 0f),
    Dummy188("dummy 188", 0, 10, 0f),
    Dummy189("dummy 189", 0, 10, 0f),
    Dummy190("dummy 190", 0, 10, 0f),
    Dummy191("dummy 191", 0, 10, 0f),
    Dummy192("dummy 192", 0, 10, 0f),
    Dummy193("dummy 193", 0, 10, 0f),
    Dummy194("dummy 194", 0, 10, 0f),
    Dummy195("dummy 195", 0, 10, 0f),
    Dummy196("dummy 196", 0, 10, 0f),
    Dummy197("dummy 197", 0, 10, 0f),
    Dummy198("dummy 198", 0, 10, 0f),
    Dummy199("dummy 199", 0, 10, 0f);
